...
// var countriesmapname = countries_data.map((country) => country.name);
// console.log(countriesmapname);
// var countriesmapcapital = countries_data.map((country) => country.capital);
// var countriesmappopulation = countries_data.map((country) => country.population);
// console.log(countriesmappopulation, countriesmapcapital);

// // const languageCount = countriesmaplangues.reduce(function (accumulator, currentValue) {
// //   currentValue.forEach(function (language) {
// //     const existingLanguage = accumulator.find(function (item) {
// //       return item.country === language;
// //     });
// //     if (existingLanguage) {
// //       existingLanguage.count += 1;
// //     } else {
// //       accumulator.push({ country: language, count: 1 });
// //     }
// //   });
// //   return accumulator;
// // }, []);
...
//   let countriesmaplangues = countries.map(function (country) {
//     return country.languages;
//   });
//   const languageCount = countriesmaplangues.reduce((acc, currentValue) => {
//     currentValue.forEach((language) => {
//       const existingLanguage = acc.find(function (item) {
//         return item.country === language;
//       });
//       if (existingLanguage) {
//         existingLanguage.count++;
//       } else {
//         acc.push({ country: language, count: 1 });
//       }
//     });
//     return acc;
//   }, []);
...
//   var topNcountries = languageCount.slice(0, n);
...
//   var mostpopulatedCountries = countries.reduce(function (acc, country) {
//     acc.push({ country: country.name, population: country.population });
//     return acc;
//   }, []);

//   mostpopulatedCountries.sort((a, b) => b.population - a.population);
//   TopNcountries = mostpopulatedCountries.slice(0, n);
//   return TopNcountries;
// }
...
// Statistic.count = function (array) {
//   console.log(array.length);
// };
// Statistic.sum = function (array) {
//   return array.reduce(function (acc, numb) {
//     return acc + numb;
//   });
// };
// Statistic.min = function (array) {
//   return Math.min(...array);
// };
// Statistic.max = function (array) {
//   return Math.max(...array);
// };
// Statistic.Range = function (array) {
//   let Range = Math.max(...array) - Math.min(...array);
//   return Range;
// };

// Statistic.mean = function (array) {
//   var sum = array.reduce((acc, currentValue) => acc + currentValue);
//   let arraylength = array.length;
//   let mean = sum / arraylength;
//   return mean;
// };

// Statistic.median = function (array) {
//   var sum = array.reduce((acc, currentValue) => acc + currentValue);
//   let arraylength = array.length;
//   let mean = sum / arraylength;
//   return Math.floor(mean);
// };
// console.log(Statistic.median(ages));

// Statistic.mode = function (array) {
//   let agesreduce = array.reduce(function (acc, numb) {
//     const existingnumb = acc.find(function (item) {
//       return item.mode === numb;
//     });
//     if (existingnumb) {
//       existingnumb.count++;
//     } else {
//       acc.push({ mode: numb, count: 1 });
//     }
//     return acc;
//   }, []);
//   let agessort = agesreduce.sort((a, b) => b.count - a.count);
//   let agesmost = agessort.slice(0, 1);
//   return agesmost;
// };

// Statistic.variance = function (array) {
//   var sum = array.reduce((acc, value) => acc + value);
//   var mean = sum / array.length;

//   var sumofsquardedDiff = array.reduce((acc, val) => {
//     var diff = val - mean;
//     return acc + diff * diff;
//   }, 0);

//   var variance = (sumofsquardedDiff / array.length).toFixed(1);
//   return variance;
// };

// Statistic.std = function (array) {
//   var sum = array.reduce((acc, value) => acc + value);
//   var mean = sum / array.length;

//   var sumofsquardedDiff = array.reduce(function (acc, val) {
//     var diff = val - mean;
//     return acc + diff * diff;
//   }, 0);
//   var StandardDeviation = Math.sqrt(sumofsquardedDiff / array.length).toFixed(1);
//   return StandardDeviation;
// };

// var array = ages;
// var arrayreduce = array.reduce(function (acc, val) {
//   var existingnumb = acc.find(function (item) {
//     return item.mode === val;
//   });
//   if (existingnumb) {
//     existingnumb.count++;
//   } else {
//     acc.push({ count: 1, mode: val });
//   }
//   return acc;
// }, []);
// console.log(arrayreduce);

// // var countriesdata = countries_data.map((value) => value.languages);
// // console.log(countriesdata);
// // var Languagecount = countriesdata.reduce(function (acc, val) {
// //   val.forEach(function (language) {
// //     const existingLanguage = acc.find(function (item) {
// //       return item.country === language;
// //     });
// //     if (existingLanguage) {
// //       existingLanguage.count++;
// //     } else acc.push({ country: language, count: 1 });
// //   });
// //   return acc;
// // }, []);
